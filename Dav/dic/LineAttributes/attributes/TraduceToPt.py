...
TraduceToPt = {
    ...
    "selecionar atributos de linha": attributes["select"],
    "escolher atributos": attributes["select"],
    "mudar atributos": attributes["change"],
    "alterar atributos": attributes["change"],
