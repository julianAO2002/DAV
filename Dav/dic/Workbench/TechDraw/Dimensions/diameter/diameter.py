...
def _create_diameter():
    """Add a diameter dimension to the active TechDraw page using the current selection.
    ...
    if page is None:
        ...
        return
    dim              = doc.addObject("TechDraw::DrawViewDimension", "DiameterDimension")
    dim.Type         = "Diameter"
