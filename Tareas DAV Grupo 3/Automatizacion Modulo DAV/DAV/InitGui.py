...
# InitGui.py - Workbench DAV
import FreeCADGui

class DAVWorkbench(FreeCADGui.Workbench):
    MenuText = "DAV"
    ToolTip = "Diseño Asistido por Voz"

    def Initialize(self):
        # Aquí se agregarán comandos y barras de herramientas en el futuro
        pass
...
FreeCADGui.addWorkbench(DAVWorkbench())
print("DAV: Workbench registrado.")
